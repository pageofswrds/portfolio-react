...
import { Mail, Page, Minus, Plus, Linkedin } from "iconoir-react";

const readcvSrc = "/fa/readcv.svg";
...
const AboutSection: React.FC<AboutSectionProps> = () => {
  ...
  return (
    <section
      id="aboutSection"
      className="elevation-1 flex flex-col gap-4 md:sticky md:top-16 md:min-w-[300px] md:max-w-[400px] "
    >
          ...
          <div id="contactView" className="flex flex-col gap-3">
            <div className="flex gap-4">
              <Button variant="secondary" className="w-full" asChild>
                <Link
                  href="https://schultzdavidg-portfolio.s3.us-west-1.amazonaws.com/files/SchultzDavid-Resume.pdf"
                  target="_blank"
                >
          ...
          <div id="detailsView" className="flex flex-col">
            ...
            <div className="bg-background flex flex-col gap-3">
              ...
              <p>
                ...
                from the University of Washington&apos;s prestigious Interaction
                Design program in 2024, where I ultimately focused on sharpening
                my design process. This involved extensive user
                research&mdash;both academically, and professionally.
              </p>
              <p>
                But historically, I&apos;ve spent a lot of time developing. I
                have extensive experience in frontend technologies. My
                bread-and-butter is Next.js and TailwindCSS, which I have been
                practicing since 2020. Recently, I&apos;ve developed proficiency
                in Rust (backend) and Swift (iOS). I&apos;ve also worked with 3D
                technologies: namely, prototyping with extended reality (XR) in
                C# (Unity + Meta&apos;s XR SDK). My niche in XR focuses on
              ...
              <p>
                ...
                brain&rdquo;. In this, I&apos;ve come to understand that design
                is the intersection between art and engineering&mdash;and this
                blend guides everything I do. My calling is to build products
                for end-users, and this entails picking up any hard skill that
                serves that end.
              </p>
              <p>
                ...
                confidence is knowing what you don&apos;t know, and I walk the
                line well. I seek out information when it&apos;s needed, and
                shift my focus to action once I&apos;ve accumulated enough.
                (e.g. knowing when I need to do user research, and when
                I&apos;ve learned enough.)
              </p>
